        ...
        <div className="main-container">
          ...
          >
            ...
            <ul>
              ...
              <li>
                <a href="/">Delivery & Ecommerce</a>
              </li>
              <li>
                <a href="/">Health & Consultation</a>
              </li>
              <li>
                <a href="/">Transport & Mobility</a>
              </li>
              <li>
                <a href="/">Banking & Financial</a>
              </li>
              <li>
                <a href="/">Food & Hospitality</a>
              </li>
              <li>
                <a href="/">EdTech</a>
              </li>
          ...
          >
            ...
            <div className="touch-section">
              ...
              <div className="detail">
                ...
                <div className="detail-content">
                  <a href="/"> 128 itire Road Lawanson Surulere</a>
                </div>
              </div>
            </div>
          </motion.div>
